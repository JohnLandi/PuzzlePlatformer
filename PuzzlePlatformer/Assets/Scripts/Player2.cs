/* This is the player two script for the character that can shoot
*/
...
public class Player2 : MonoBehaviour {
	...
	void Update () 
	{
		if(gameController.whichPlayer == 2)
		{
	...
	void OnTriggerEnter2D(Collider2D other)
	{
		...
		if((other.gameObject.tag == ("Enemy") || other.gameObject.tag == ("Hazzard")) && gameObject.tag == ("Player2"))
		{
			gameController.playerRespawn2();
		}
	...
	public void PlayerControls()
	{
		...
		if(Input.GetButtonDown("Jump") && grounded && gameObject.tag == ("Player2"))
		{
